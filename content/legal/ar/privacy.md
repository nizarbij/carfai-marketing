...
### 1.4 معالجة الذكاء الاصطناعي ومزوّد الذكاء الاصطناعي الخارجي

يعتمد CarFai على **Anthropic, PBC** (مطوّر عائلة نماذج الذكاء الاصطناعي Claude) بوصفه مزوّد ذكاء اصطناعي خارجي لدعم ميزتين موجّهتين للمستخدم:

- **مسح المستندات** — استخراج المبلغ والتاريخ والمورّد والفئة من صور المستندات (الإيصالات والفواتير ووثائق التسجيل) التي تلتقطها أو ترفعها.
- **AI Advisor** — الإجابة عن الأسئلة التي تطرحها بشأن سيارتك (إرشادات الصيانة، وتحليل التكاليف، والأسئلة العامة عن السيارة).

**البيانات المُرسَلة إلى Anthropic**:
- صور ونصوص المستندات التي تمسحها أو ترفعها.
- تفاصيل سيارتك (الصنع، الطراز، السنة، عدد الكيلومترات، النفقات، وأي حقول أخرى أدخلتها).
- الأسئلة والرسائل التي ترسلها إلى AI Advisor.

**كيف تُجمع هذه البيانات**: من المستندات التي تلتقطها أو ترفعها داخل التطبيق، ومن المعلومات التي تدخلها بشأن سيارتك.

**كيف تستخدم Anthropic هذه البيانات**: حصريًا لتقديم استجابة الذكاء الاصطناعي المطلوبة — أي (أ) استخراج الحقول من مستنداتك، و(ب) توليد إرشادات الصيانة والتكلفة، و(ج) الإجابة عن أسئلتك.

**الشروط التعاقدية وشروط المعالجة**:
- تعالج Anthropic بياناتك بموجب اتفاقية معالجة بيانات (شروط عملاء Anthropic التجاريين) توفّر حماية معادلة لالتزامات CarFai المنصوص عليها في هذه السياسة.
- **لا تستخدم Anthropic بياناتك لتدريب نماذجها**.
- البيانات **مشفَّرة أثناء النقل** بين تطبيق CarFai وخوادم Anthropic (TLS 1.2+).

**موافقتك وتحكّمك**:
- عليك تقديم **موافقة صريحة داخل التطبيق** قبل إرسال أي بيانات إلى Anthropic.
- يمكنك **سحب هذه الموافقة في أي وقت** من **الإعدادات ← الخصوصية**. سحب الموافقة يعطّل ميزات الذكاء الاصطناعي المذكورة أعلاه.

للاطلاع على التفاصيل التقنية الكاملة لما يرسله CarFai إلى Anthropic في كل طلب، ومدد الاحتفاظ، وكيفية اعتماد ميزات الذكاء الاصطناعي على بياناتك الشخصية مقابل المرجعيات المجتمعية المجهولة الهوية مقابل محتوى الويب العام، راجع **القسم 4 — معالجة الذكاء الاصطناعي — إفصاح خاص**.
...
| v1.1 | 2026-07-18 | إضافة القسم 1.4 «معالجة الذكاء الاصطناعي ومزوّد الذكاء الاصطناعي الخارجي» — إفصاح بلغة واضحة عن الاعتماد على Anthropic، وتدفّق موافقة صريحة داخل التطبيق، وإمكانية السحب من الإعدادات ← الخصوصية. القسم 4 القائم (شروط معالجة الذكاء الاصطناعي التفصيلية) لم يتغيّر. |
