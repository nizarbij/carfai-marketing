...
- **CarFai** — **CarFai** (« nous » ou le « Sous-traitant »), situé à l'**adresse disponible sur demande via carfai.info@gmail.com**.
...
1. **Traiter les Données Personnelles uniquement sur les instructions documentées du Client**, y compris les instructions implicites dans l'utilisation du Service par le Client conformément aux Conditions d'Utilisation. CarFai informera le Client s'il estime qu'une instruction enfreint les Lois sur la Protection des Données.

2. **Assurer la confidentialité** — Le personnel de CarFai ayant accès aux Données Personnelles est tenu par des obligations de confidentialité.

3. **Mettre en œuvre des mesures techniques et organisationnelles appropriées** (« MTO ») pour protéger les Données Personnelles, telles que décrites à l'**Annexe 2** ci-dessous.

4. **Engager des Sous-traitants ultérieurs uniquement tel qu'autorisé** en vertu de la Section 7.

5. **Assister le Client** pour :
