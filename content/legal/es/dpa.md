...
- **CarFai** — **CarFai** ("nosotros" o "Encargado del Tratamiento"), con domicilio en **dirección disponible previa solicitud a través de carfai.info@gmail.com**.
...
2. **Garantizar la confidencialidad** — El personal de CarFai con acceso a los Datos Personales está sujeto a obligaciones de confidencialidad.

3. **Implementar medidas técnicas y organizativas apropiadas** ("MTO") para proteger los Datos Personales, según se describe en el **Anexo 2** a continuación.

4. **Contratar Subencargados del Tratamiento únicamente según lo autorizado** en la Sección 7.

5. **Asistir al Cliente** en:
