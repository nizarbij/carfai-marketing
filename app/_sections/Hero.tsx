    ...
    <section className="relative overflow-hidden">
      <div className="mx-auto max-w-6xl px-6 pt-12 pb-20 md:pt-32 md:pb-40">
        ...
        {/*
          ...
          Mobile uses a 4:3 aspect so the image has more vertical
          presence on narrow widths (16:9 of 327px = only 184px tall).
          Desktop stays 16:9 — proper cinematic letterbox.
        */}
